...
public class PaymentCaseToCCDMapperUTest {
    ...
    public void shouldMapAllAndTransformAllFieldsForPaymentsMappingScenario() throws URISyntaxException, IOException {
        ...
        CoreCaseData expectedCoreCaseData = (CoreCaseData) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/paymentcase.json", PaymentCaseToCCDMapperUTest.class,
                CoreCaseData.class);
        ...
        DivorceSession divorceSession = (DivorceSession) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/payment.json", PaymentCaseToCCDMapperUTest.class,
    ...
    public void shouldAddANewPaymentToExistingPaymentsMappingScenario() throws URISyntaxException, IOException {
        ...
        CoreCaseData expectedCoreCaseData = (CoreCaseData) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/additionalpayment.json", PaymentCaseToCCDMapperUTest.class,
                CoreCaseData.class);

        expectedCoreCaseData.setCreatedDate(LocalDate.now().format(ofPattern("yyyy-MM-dd")));

        DivorceSession divorceSession = (DivorceSession) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping//additional-payment.json", PaymentCaseToCCDMapperUTest.class,
                DivorceSession.class);
    ...
    public void shouldReplaceExistingPaymentWithNewPaymentWhenTransactionIdIsSameMappingScenario()
        ...
        CoreCaseData expectedCoreCaseData = (CoreCaseData) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/overwritepayment.json", PaymentCaseToCCDMapperUTest.class,
                CoreCaseData.class);

        expectedCoreCaseData.setCreatedDate(LocalDate.now().format(ofPattern("yyyy-MM-dd")));

        DivorceSession divorceSession = (DivorceSession) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/overwrite-payment.json", PaymentCaseToCCDMapperUTest.class,
                DivorceSession.class);
    ...
    public void shouldAddPaymentWhenOnlyTransactionIdIsPopulated() throws URISyntaxException, IOException {
        ...
        CoreCaseData expectedCoreCaseData = (CoreCaseData) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/paymentidonly.json", PaymentCaseToCCDMapperUTest.class,
                CoreCaseData.class);

        expectedCoreCaseData.setCreatedDate(LocalDate.now().format(ofPattern("yyyy-MM-dd")));

        DivorceSession divorceSession = (DivorceSession) DivorceCaseToCCDMapperTestUtil
            .jsonToObject("fixtures/ccdmapping/payment-id-only.json", PaymentCaseToCCDMapperUTest.class,
                DivorceSession.class);
